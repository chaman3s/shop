...
export default function SignupPage() {
  ...
  const handleDetailsSubmit = async (
    ...
    try {
      ...
      setSuccessMessage(body.message || "OTP sent to your email.");
      if (!body.emailSent && body.emailReason) {
  ...
  const handleOtpSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const message =
        submitError instanceof Error ? submitError.message : "Invalid OTP.";
      setError(message);
    } finally {
      setIsSubmitting(false);
    }
